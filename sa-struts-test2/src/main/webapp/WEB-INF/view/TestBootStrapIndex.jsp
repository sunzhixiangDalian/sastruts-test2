...
<html lang="en">
  <head>
    ...
    <title>test Bootstrap in the subject</title>
  ...
  <body>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Author Info</a>
        </div>
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Info Dropdown <b class="caret"></b></a>
              <ul class="dropdown-menu">
                <li><a href="#">Mail:zhixiang.sun@bric.jp</a></li>
                <li><a href="#">Address: Ueno 3-16-2</a></li>
                <li><a href="#">Tel: 09064826406</a></li>
                <li class="divider"></li>
                <li class="dropdown-header">Company</li>
                <li><a href="#">Bricolage.jp</a></li>
              </ul>
            </li>
          </ul>
        </div><!--/.nav-collapse -->
    ...
    <div class="container theme-showcase">
      ...
      <div class="jumbotron">
        <h1>Assignment課題</h1>
        <p>SA-Strutsを利用した簡単なWebアプリケーションの作成.</p>
        <p><a class="btn btn-primary btn-lg"  href="userManager">Get into the UserManager &raquo;</a></p>
      </div>
